...
![Scenarios when summarising tables](/post/2018-11-04-summarising_tables_files/summarising_tables.png)
...
This confirms 9 tables imported, specifying the rows `nrow` and columns `ncol` of each nested tibble.
