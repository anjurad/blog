...
*Exception* reporting allows users to focus on programme exceptions.  It becomes a challenge to focus on relevant and current issues when presented with a sea of data, so cutting to the heart of prioritised issues and opportunities are hugely efficient and effective.  
