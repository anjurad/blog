...
iris_grouped <-
  ...
  # Make the table long and thin by brinding numeric attributes describing Sepal
  # and Petal lengh and width into one columns named `Field`.
...
iris_grouped %>%
  ...
  # The function returns the first 4 rows of the dataframe, formatting the output to
  # HTML using knitr and kableextra, printing a passed header as shown below
