...
- The previous behaviour was renamed to `group_modify()`, which always returns a grouped tibble, combining returned tibbles by evaluating each operation with a reconstructed grouping structure.
