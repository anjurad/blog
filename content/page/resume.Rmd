...
I have spent a considerable time analysing data, focussing on prediction and inference.  It naturally led me to the emerging *Data Science* field which, at the same time, had been exploding with powerful and accessible tools and techniques.<br><br>
Using an increasingly broader range of and more advanced solutions ultimately fuelled my a thirst for a comprehensive, more in-depth and thorough education in all key aspects of the discipline.<br><br>
Data Science is a vast and evolving field with many disciplines.  I can never know enough, so continous learning has become a way of life.<br><br><hr><br>
...
In 2013 Nokia commenced work on a significant, complex and large-scale programme without a suitable tool to manage the work. I got the ball rolling with a few tactical solutions but ended up designing, building and implementing ‘Nisaba’, a web-based workflow, data concentrator/ warehouse and reporting solution used to manage *2G Refresh* and *3UK programmes of work*.  

Nisaba was built using a LAMP stack and hosted on AWS, using a RabbitMQ as messaging and queuing solution for exports.

I specialised in MySQL, creating and configuring databases, provisioning users and setting privileges.  I designed database structures and created normalised tables and queries.  I wrote Stored Procedures, Triggers and Functions to automate the solution and add features in conjunction with the application.<br><br>

My team and I continued to provide the [SAAS](https://en.wikipedia.org/wiki/Software_as_a_service) solution after I left Nokia as a consultant.  It supported a few hundred users for almost 4 years, despite being introduced as a tactical solution only.<br><br><hr><br>
...
- Financial, planning, budgeting and reporting.  Vodafone was able to recoup several million pounds of overspend.  I contributed by algorithmically auditing and classifying anomalous entries in extensive itemised purchase order schedules.
...
- Refreshed and updated my knowledge on statistics and probability, focussing on using programming to perform calculations and tests.<br><br>
